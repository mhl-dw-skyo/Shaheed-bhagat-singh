...
class NearByController extends GetxController {
  ...
  Future<void> onInit() async {
    ...
    directions.clear();
    DirectionModel directionModel1 = DirectionModel(id: 1, name: commonService.labelData.value.data.bhagatSinghKhalsa);
    directions.add(directionModel1);
    DirectionModel directionModel2 = DirectionModel(id: 2, name: commonService.labelData.value.data.currentLocation);
