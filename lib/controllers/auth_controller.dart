...
class AuthController extends GetxController {
  ...
  CategoryTypeController categoryTypeController =
      !Get.isRegistered<CategoryTypeController>()
          ? Get.put(CategoryTypeController())
          : Get.find();

  DetailController detailController = Get.find();
  NearByController nearByController = !Get.isRegistered<NearByController>()
      ? Get.put(NearByController())
      : Get.find();
  SplashController splashController = !Get.isRegistered<SplashController>()
